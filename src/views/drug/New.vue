    ...
    <a-card :bordered="false">
      ...
      >
        ...
        >
          ...
          <a-select
            style="width: 100px"
            v-model="form.package1Name"
          >
            <a-select-option
              v-for="(item,index) in package1Options"
              :value="item"
              :key="index"
            >
              {{ item }}
          ...
          <a-select
            style="width: 100px"
            v-model="form.package2Name"
          >
            <a-select-option :value="0">
              无
            </a-select-option>
            <a-select-option
              v-for="(item,index) in package2Options"
              :value="item"
              :key="index"
            >
              {{ item }}
          ...
          <a-select
            style="width: 100px"
            v-model="form.package3Name"
          >
            <a-select-option :value="0">
              无
            </a-select-option>
            <a-select-option
              v-for="(item,index) in package3Options"
              :value="item"
              :key="index"
            >
              {{ item }}
